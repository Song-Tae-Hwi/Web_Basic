...
/*
    ...
    - 원본 배열 변경 X
    - forEach는 단순히 요소나 인덱스를 가지고 작업만 진행 (반환값 X), map은 요소나 인덱스를 가지고 작업한 결과로 새로운 배열을 생성
*/
...
/*
    filter(콜백 함수) : 콜백 함수의 반환값이 true 인 배열의 요소의 값만 추출한 새로운 배열을 생성
...
/*
    findIndex(콜백 함수) : 콜백 함수가 결과가 true인 첫번째 요소의 인덱스를 반환
*/
