...
class Sample4 {
    ...
    setMethod() {
        //     this.field1 = '읽기전용에서의 변경'; // 상수형태로 지정되어 있기 때문에 변경 불가능
    }
}

const sample4Instance = new Sample4('읽기전용2', '읽기전용3');
console.log(sample4Instance);
// sample4Instance.field1 = '변경'; // readonly가 있어 인스턴스에 값의 할당 불가
...
abstract class AbstractClass {
    abstract abtractMethod(arg: string): void;
}

class SubClass extends AbstractClass {

    abtractMethod(arg: string): void {
