...
/*
    ...
    - 할당 기준은 인덱스
*/
// 만약에 배열 디스트럭처링에 배열의 길이를 초과한 변수를 선언하면 초과한 범위에 해당하는 변수는 undefined 지정됨
...
// const [...otherFruits2, anotherfruits2] = fruits;
...
const { name: name1, tomb, birth } = king;
console.log(name1, tomb, birth);
